      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h4 class="section-heading">Reporte Top Catedraticos por Unidad Academica</h4>
            <br>
            <h3 class="section-heading">Top 10 Catedraticos de Unidad Academica: {{$users->unidad}}</h3>
            <hr class="my-4">
          </div>
        </div>
      </div>
